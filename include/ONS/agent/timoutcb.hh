#ifndef ONS_AGENT_TIMOUTCB_HH
#define ONS_AGENT_TIMOUTCB_HH
/*
// ============================================================================
//
// = LIBRARY
...
class ONS_TimeoutCallback_mf1s_c : public ONS_EventCallback
{
  public:

    typedef void	(T2::*M)(char const*) const;

			~ONS_TimeoutCallback_mf1s_c()
...
template<class T1, class T2>
inline void ONS_TimeoutCallback_mf1s_c<T1,T2>::execute(
 OTC_Event* theEvent,
 void*
)
{
  (*agent_.*method_)(((OTCEV_Timeout*)theEvent)->description());
}

template<class T1, class T2>
class ONS_TimeoutCallback_mf1s : public ONS_EventCallback
{
  public:

    typedef void	(T2::*M)(char const*);

			~ONS_TimeoutCallback_mf1s()
				{ ONS_CallbackObject<T1>::release(agent_); }
...
template<class T1, class T2>
inline void ONS_TimeoutCallback_mf1s<T1,T2>::execute(
 OTC_Event* theEvent,
 void*
)
{
...
template<class T1, class T2>
class ONS_TimeoutCallback_cb1s_c : public ONS_EventCallback
{
  public:

    typedef ONS_Callback1<char const*> const	T2::*M;

			~ONS_TimeoutCallback_cb1s_c()
				{ ONS_CallbackObject<T1>::release(agent_); }
...
template<class T1, class T2>
inline void ONS_TimeoutCallback_cb1s_c<T1,T2>::execute(
 OTC_Event* theEvent,
 void*
)
{
...
template<class T1, class T2>
class ONS_TimeoutCallback_cb1s : public ONS_EventCallback
{
  public:

    typedef ONS_Callback1<char const*>	T2::*M;

			~ONS_TimeoutCallback_cb1s()
				{ ONS_CallbackObject<T1>::release(agent_); }
...
template<class T1, class T2>
inline void ONS_TimeoutCallback_cb1s<T1,T2>::execute(
 OTC_Event* theEvent,
 void*
)
{
...
template<class T1, class T2>
class ONS_TimeoutCallbackFactory
{
  public:
    ...
    static ONS_EventCallback*	create(T2 const* theAgent,
     void (T2::*theMethod)(char const*) const)
      { return (theAgent != 0 && theMethod != 0) ?
       new ONS_TimeoutCallback_mf1s_c<T1,T2>(theAgent,theMethod) : 0; }

    static ONS_EventCallback*	create(T2* theAgent,
     void (T2::*theMethod)(char const*))
      { return (theAgent != 0 && theMethod != 0) ?
       new ONS_TimeoutCallback_mf1s<T1,T2>(theAgent,theMethod) : 0; }

    static ONS_EventCallback*	create(T2 const* theAgent,
     ONS_Callback1<char const*> const T2::*theMethod)
      { return (theAgent != 0 && theMethod != 0) ?
       new ONS_TimeoutCallback_cb1s_c<T1,T2>(theAgent,theMethod) : 0; }

    static ONS_EventCallback*	create(T2* theAgent,
     ONS_Callback1<char const*> T2::*theMethod)
      { return (theAgent != 0 && theMethod != 0) ?
       new ONS_TimeoutCallback_cb1s<T1,T2>(theAgent,theMethod) : 0; }
