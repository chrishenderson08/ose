#ifndef OTC_COLLCTN_ITMAP_HH
#define OTC_COLLCTN_ITMAP_HH
/*
// ============================================================================
//
// = LIBRARY
...
#pragma implementation "OTC/collctn/itmap.hh"
#endif
#pragma interface "OTC/collctn/itmap.hh"
#endif
#endif
...
class OTC_ITMap
    ...
    //	   the map as <OTC_ITMap\<EX_Foo const*,EX_Bar*\>> and not just
    //	   <OTC_ITMap\<EX_Foo*,EX_Bar*\>>. If this is not done, it would be
    ...
    //     <OTC_PairModifier>
{
  public:
    ...
    OTC_ITMap<T1,T2>&	operator=(OTC_ITMap<T1,T2> const& theMap);
...
#if !defined(OSE_DISABLE_TEMPLATE_INCLUSION)
#include <OTC/collctn/itmap.c>
#endif

/* ------------------------------------------------------------------------- */

#endif /* OTC_COLLCTN_ITMAP_HH */
