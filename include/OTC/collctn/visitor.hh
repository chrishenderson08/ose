#ifndef OTC_COLLCTN_VISITOR_HH
#define OTC_COLLCTN_VISITOR_HH
/*
// ============================================================================
//
// = LIBRARY
...
#pragma implementation "OTC/collctn/visitor.hh"
#pragma interface "OTC/collctn/visitor.hh"
#endif
#endif
#endif
...
template<class T>
class OTC_Visitor : public OTC_Applicator
    // = TITLE
    ...
    //
    // = DESCRIPTION
    //     The <OTC_Visitor> class provides an alternative to using the
    //     <OTC_Iterator> class to act on items in a collection. Support for
    //     the <OTC_Visitor> class can also be provided on collection type
    ...
    //
    //     Through the <OTC_Visitor> class, it is possible to modify the
    ...
    //     <OTC_Worker>, <OTC_Applicator>
{
  public:
    ...
    virtual OTC_Progress	action(T const& theItem) = 0;
  ...
  private:
			...
			OTC_Visitor(OTC_Visitor<T> const&)
				{ terminate(); }
				// Do not define an implementation for this.

    OTC_Visitor<T>&	operator=(OTC_Visitor<T> const&)
