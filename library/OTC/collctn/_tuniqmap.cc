...
#include <OTC/collctn/tuniqmap.hh>
...
void test4()
{
  ...
  OTC_TUniqMap<int,int> map2(map1);
...
void test10()
{
  ...
  OTC_TUniqMap<char const*,int> map;
  ...
  while (cin.good())
  {
    ...
    if (!cin.fail())
    {
      ...
      pairs = map.pairsKey(buf1,test10_rank);
      while (pairs.isValid())
      {
